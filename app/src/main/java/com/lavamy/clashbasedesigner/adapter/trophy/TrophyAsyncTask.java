package com.lavamy.clashbasedesigner.adapter.trophy;
...
public class TrophyAsyncTask extends AsyncTask<Void, Collection, Void> {
    ...
    public TrophyAsyncTask(Context context, String directory, CollectionListViewAdapter collectionListViewAdapter, CollectionGridViewAdapter collectionGridViewAdapter) {
    ...
    protected Void doInBackground(Void... params) {
        TrophyManager.getInstance().collections = new ArrayList<>();
        for (String path : Utils.listFiles(directory, context)) {
            ...
            TrophyManager.getInstance().collections.add(collection);
