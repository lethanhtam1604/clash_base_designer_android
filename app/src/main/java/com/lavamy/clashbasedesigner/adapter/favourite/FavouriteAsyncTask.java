package com.lavamy.clashbasedesigner.adapter.favourite;
...
public class FavouriteAsyncTask extends AsyncTask<Void, Collection, Void> {

    private CollectionListViewAdapter collectionListViewAdapter;
    private CollectionGridViewAdapter collectionGridViewAdapter;

    public FavouriteAsyncTask(CollectionListViewAdapter collectionListViewAdapter, CollectionGridViewAdapter collectionGridViewAdapter) {
    ...
    protected Void doInBackground(Void... params) {
        for (Collection collection : FavouriteManager.getInstance().collections) {
