...
public class CollectionGridViewAdapter extends BaseAdapter {
    ...
    public CollectionGridViewAdapter(Context context, FavouriteInterface favouriteInterface, TownHallInterface townHallInterface) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_layout_grid, parent, false);
        }
